...
\end{verbatim}
\lstinputlisting[language=R, firstline=29, lastline=33]{PS03_Answers_IB.R}
...
\lstinputlisting[language=R, firstline=33, lastline=34]{PS03_Answers_IB.R}

\item Create an age variable and group into categories (e.g., $<$30, 30-44, 45-64, 65+). Year of birth is in age (four‑digit year).
\lstinputlisting[language=R, firstline=36, lastline=42]{PS03_Answers_IB.R}
\end{enumerate}
...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=45, lastline=53]{PS03_Answers_IB.R}
	...
	\lstinputlisting[language=R, firstline=56, lastline=68]{PS03_Answers_IB.R}
	\include{density.pdf}
	...
	\lstinputlisting[language=R, firstline=69, lastline=83]{PS03_Answers_IB.R}
