...
\end{verbatim}
\lstinputlisting[language=R, firstline=29, lastline=33]{PS02_Answers_IB.R}
...
\lstinputlisting[language=R, firstline=33, lastline=34]{PS02_Answers_IB.R}

\item Create an age variable and group into categories (e.g., $<$30, 30-44, 45-64, 65+). Year of birth is in age (four‑digit year).
\lstinputlisting[language=R, firstline=36, lastline=42]{PS02_Answers_IB.R}
\end{enumerate}
...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=45, lastline=53]{PS02_Answers_IB.R}
	\include{turnoutage.pdf}
	...
	\lstinputlisting[language=R, firstline=56, lastline=68]{PS02_Answers_IB.R}
	\include{density.pdf}
	\item Produce histogram counts of turnout by income (\texttt{income\_full}), faceted by province.
	Can't figure out how to make this work properly- I suspect I'm missing some fundamental piece of this. Will come to office hours to figure it out. In the meantime, enjoy this abomination that's about as far as I got.
	\lstinputlisting[language=R, firstline=69, lastline=83]{PS02_Answers_IB.R}
	\include{turnoutincome.pdf}
	...
	\end{enumerate}
	Haven't yet gotten to this, hopefully will by the time I actually upload this. This is a pre-emptive upload that I'm hoping to replace with a better one later.
